...
DOCS docs website is a static website generated via SSG functionality from a Next.js+[Fumadocs](https://fumadocs.dev) application.
...
- `examples`: runnable DOCS code samples to be used as code snippets on content via code injection tools.
